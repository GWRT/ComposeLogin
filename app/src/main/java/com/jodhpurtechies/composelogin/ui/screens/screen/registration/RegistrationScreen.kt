...
import com.jodhpurtechies.composelogin.ui.screens.screen.registration.state.RegistrationUiEvent
            ...
            ElevatedCard(
                ...
                Column(
                    ...
                    RegistrationInputs(
                        ...
                        onNicknameChange = { inputString ->
                            registrationViewModel.onUiEvent(
                                registrationUiEvent = RegistrationUiEvent.NicknameChanged(
                                    inputValue = inputString
                                )
                            )
                        },
