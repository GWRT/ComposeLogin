...
import com.jodhpurtechies.composelogin.ui.screens.screen.registration.state.RegistrationState
...
fun RegistrationInputs(
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        MobileNumberTextField(
            ...
            isError = registrationState.errorState.nicknameErrorState.hasError,
            errorText = stringResource(id = registrationState.errorState.nicknameErrorState.errorMessageStringResource),
            imeAction = ImeAction.Next
        )
